...
export function getSortedDataByDirections(id) {
  ...
  const u = universities[0]
        .flatMap(({ university_edrpou, university_financing_type_name, region_name, university_short_name, speciality_licenses }) => speciality_licenses.map(lic => ({ ...lic, university_edrpou, university_financing_type_name, region_name, university_short_name, type: 'university' })));
  const c = colleges[0]
        .flatMap(({ university_edrpou, university_financing_type_name, region_name, university_short_name, speciality_licenses }) => speciality_licenses.map(lic => ({ ...lic, university_edrpou, university_financing_type_name, region_name, university_short_name, type: 'college' })));
